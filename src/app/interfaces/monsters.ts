...
export class Convert {
  public static toMonsters(json: string): Monsters[] {
      return cast(JSON.parse(json), a(r("Monsters")));
  }

  public static monstersToJson(value: Monsters[]): string {
      return JSON.stringify(uncast(value, a(r("Monsters"))), null, 2);
  }
}
...
const typeMap: any = {
  "Monsters": o([
      { json: "monsterId", js: "monsterId", typ: "" },
      { json: "name", js: "name", typ: r("Name") },
      { json: "japaneseName", js: "japaneseName", typ: u(null, "") },
      { json: "elementalAffinity", js: "elementalAffinity", typ: u(null, "") },
      { json: "elementalWeakness", js: "elementalWeakness", typ: u(null, "") },
